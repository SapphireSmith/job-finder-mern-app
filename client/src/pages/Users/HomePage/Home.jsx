...
import { getJobPosts, getUsers } from '../../../helper/helpers'
                        ...
                        <div className='jobs-listing-menu'>
                            ...
                            <div className='pt-3 px-6'>
                                <p className='text-white font-medium'>
                                    <span className='italic font-medium'>{postCount || 0}</span> {userType() ? 'Profile found' : 'Jobs found.'}
                                </p>
                            </div>
                            {
                                userType() ? <UserCard post={post} /> : <JobCard post={filteredList} />
                            }
                        </div>
                    </div>
                </div>
